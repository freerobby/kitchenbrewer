...
Date.prototype.toFormattedString = function(include_time){
  ...
  var gmtHours = this.getTimezoneOffset()/60 * -1;
  var gmtHoursDisplay = Math.abs(gmtHours) * 100;
  str += " ";
  str += (gmtHours < 0) ? "-" : "+";
  str += "0" + gmtHoursDisplay;
  return str;
}
...
Date.parseFormattedString = function (string) {
  ...
  // 1/1/1111 01:11pm
  // 1/1/1111 1:11pm
  var regexp = "(([0-1]?[0-9])\/[0-3]?[0-9]\/[0-9]{4}) *([0-9]{1,2}(:[0-9]{2})? *(am|pm))? ([\+\-][0-9]{4})?";
